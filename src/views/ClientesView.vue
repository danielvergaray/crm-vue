...
}); /* data se obtiene de la base de datos */
...
const actualizarEstado = ({idCliente, estado}) =>{
  ClienteService.cambiarEstado(idCliente, {estado: !estado})
    .then(()=>{
        const i = clientes.value.findIndex(cliente => cliente.id === idCliente)
